...
<html>
 <head>
		...
		<link rel="stylesheet" href="/No1/css/safe/css.css" />
		<link rel="stylesheet" href="/No1/css/safe/common.min.css" />
		<link rel="stylesheet" href="/No1/css/safe/ms-style.min.css" />
		<link rel="stylesheet" href="/No1/css/safe/personal_member.min.css" />
		<link rel="stylesheet" href="/No1/css/safe/Snaddress.min.css" />
		<link rel="stylesheet" href="/No1/css/sui.css" />
...
a{
			...
			<div class="ng-toolbar-con wrapper">
				<div class="ng-toolbar-left">
					<a class="ng-bar-node ng-bar-node-backhome" id="ng-bar-node-backhome" style="display: block;">
						<span><img src="/No1/img/Home.png" style="margin-right: 10px;"/>返回1号店首页</span>
					</a>
					<div class="ng-bar-node-box ng-site-nav-box">
						<a href="" class="ng-bar-node ng-bar-node-site">
							<span><img src="/No1/img/daohang.png" style="margin-right: 5px;" />网站导航</span><em class="ng-iconfont down"></em>
						</a>
				...
				<div class="ng-toolbar-right">
					...
					<div class="ng-bar-node-box myorder-handle">
						<a class="ng-bar-node ng-bar-node-fix touch-href ng-bar-node-pr5"><span>我的一号店</span><em class="ng-iconfont down"></em></a>
					...
					<a class="ng-bar-node ng-bar-node-mini-cart" rel="nofollow" href="">
						<span><img src="/No1/img/购物车.png" />&nbsp;购物车</span>
    ...
    background: none;
				...
				<div class="header-menu">
					<div class="ms-logo">
						<a class="ms-head-logo" name="Myyigou_index_none_daohangLogo"><span style="font-size: 30px;color: #fff;font-weight: bold;    line-height: 28px;;">我的一号店</span></a>
					...
					<nav class="ms-nav">
						...
						<div class="ms-search">
							<form>
								...
								<img src="/No1/img/搜索.png"  style="height: 10px;width: 10px;float: right;margin-right: 10px;" />
							</form>
						</div>
					</nav>
				</div>
				...
				<div class="header-useinfo" id="">
					<div class="ms-avatar">
						<div class="useinfo-avatar">
							<img class="yhdimg" style="width:40; height:50 "src="/No1/img/loginlogo.jpg">
							<div class="edit-avatar"></div>
							<a class="text-edit-avatar">修改</a>
						</div>
						<a >欢迎${userInfo.nickName }来到一号店</a>
					</div>

					<div class="ms-name-info">
						<div class="link-myinfo">
							<a >我的账户：${userInfo.cname }</a>
						</div>
						<div class="info-member">
							<span class="name-member member-1">
        				 <i></i><a target="_blank" >注册会员</a></span>
							<span style="margin-left: 20px;">
        				 <a href="/No1/personalCenterRevice/center_queryOne.action?customer.cid=5"  target="_blank" >我的资料修改</a></span>
						</div>
					...
					<div class="ms-side" style="margin-top: 20px;">
						<article class="side-menu side-menu-off">
							<dl class="side-menu-tree" style="padding-left: 50px;">
								<dt><img src="/No1/img/左侧/我的购物车.png"  style="margin-right: 10px;margin-left: -20px;"/>我的购物车</dt>
								<dt><img src="/No1/img/左侧/file.png"  style="margin-right: 10px;margin-left: -20px;"/>订单管理</dt>
								<dd>
									<a>我的订单</a>
								...
								<dt><img src="/No1/img/左侧/我的买啦.png"  style="margin-right: 10px;margin-left: -20px;"/>我的买啦</dt>
								<dd>
									<a>我的推荐</a>
								...
								<dt><img src="/No1/img/左侧/v-card-3.png"  style="margin-right: 10px;margin-left: -20px;"/>售后服务</dt>
								<dd>
									<a >退换货</a>
							...
							<div class="server-tab" style="margin-top: 26px;">
								...
								<div style="float: left;width:200px ;height: 152px;;margin-left: 20px;border: 1px #ccc solid;box-shadow: 1px 1px 1px #F5F5F5;padding: 5px;">
									<div style="width: 100%;height: 100%;border: 1px #F2873B dashed;">
										...
										<img src="<%=basePath %>/No1/img/我的买豆/矢量智能对象.png" style="position: absolute; margin-top: 30px;  margin-left: -80px;;" />	
									</div>
								</div>
								...
								<div style="float: left;width:200px ;height: 152px;margin-left: 20px;border: 1px #ccc solid;box-shadow: 1px 1px 1px #F5F5F5;padding: 5px;">
									<div style="width: 100%;height: 100%;border: 1px #F2873B dashed;">
										...
										<span style="width: 87px;height: 20px;background-color: #fee3dc;padding: 5px;border: 1px #C62B26 dashed;border-radius: 5px;">显示今日收益</span>
									    <img src="/No1/img/我的买豆/猪的图标.png" style="position: absolute; margin-top: 13px;  margin-left: -80px;;" />									</div>
								</div>
								...
								<div style="float: left;width:250px ;height: 152px;margin-left: 20px;">
								 ...
								 <div style="background-color: #fff;margin-top: 10px;height: 300px;padding: 10px;">
								 	...
								 	<img src="/No1/img/个人中心/组-15.png"/>
								 	<img src="/No1/img/个人中心/组-14.png" style="margin-top: 20px;"/>
								...
								<div style="background-color: #fff;margin-top: 10px;height: 200px;padding: 10px;">
								 	...
								 	<img src="/No1/img/个人中心/形状-1.png" style="margin-top: 20px;"/>
								...
								<div style="background-color: #fff;margin-top: 10px;height: 300px;padding: 10px;">
								 	...
								 	<img src="/No1/img/个人中心/屏幕快照-2016-04-08-15.50.46.png" style="margin-top: 10px;height: 100px;width: 100px;float: left;"/>	
								 	<br />
								 	...
								 	<p style="width: 100px;font-size: 12px;color: #686868">化妆水化妆水化妆水化妆水化妆水化妆水</p>
								 	 ...
								 	 <div style="float:left ;">
								 	 	 <img src="/No1/img/个人中心/屏幕快照-2016-04-08-15.50.46.png" style="margin-top: 10px;height: 100px;width: 100px;float: left;margin-left: 20px;"/>
								 	 	<br />
								...
								<div style="background-color: #fff;margin-top: 10px;height: 200px;padding: 10px;">
								 	...
								 	<img src="/No1/img/个人中心/矢量智能对象.png" style="margin-top: 20px;"/>
		...
		<script type="text/javascript " src="/No1/js/safe/ms_common.min.js "></script>
